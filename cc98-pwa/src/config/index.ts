...
export const CDN_AVATAR_URL = 'https://cdn4.file.cc98.top'
export const CDN_IMG_URL = 'https://cdn4.file.cc98.top/static/images'
export const CDN_FILE_URL = 'https://cdn4.file.cc98.top'
